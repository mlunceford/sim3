...
class Auth extends React.Component {
    ...
    handleInput = (e) => { // name is the attribue that you always use.
        // this also makes it so you can use the same function for both username/password
        this.setState({ [e.target.name]: e.target.value}) 
    } //! handle input works console.logged
    render(){
